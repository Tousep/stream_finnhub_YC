...
def load_producer(kafka_server, security_protocol,sasl_mechanism,sasl_plain_username,sasl_plain_password,ssl_cafile):
    return KafkaProducer( bootstrap_servers=kafka_server, security_protocol=security_protocol, sasl_mechanism=sasl_mechanism, sasl_plain_username=sasl_plain_username, sasl_plain_password=sasl_plain_password, ssl_cafile=ssl_cafile)
